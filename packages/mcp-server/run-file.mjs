...
// Wrapper for the file-enabled MCP entry: sets up polyfills synchronously,
// then imports the TS entry via tsx. Same polyfill setup as run.mjs — the only
// difference is the imported entry (src/index-file.ts), whose `render_markdown`
// tool can read Markdown from a file path instead of requiring an inline string.
